...
const AssessmentTool = () => {
    ...
    return (
        <Box display={"flex"} flexDirection={"column"} mt={"70px"} >
            <Box
                bg="#014d7e"
                color="white"
            ...
            >
                ...
                <Text pl={"10px"} fontSize="3xl" fontWeight="medium" fontStyle={"italic"} textAlign={"left"} color={"gray.500"}>
            ...
            <Box bg={"#ffffff"} boxShadow={"lg"}>
                <Box color={"gray.500"} padding={"50px"} >
                    ...
                    <Box fontSize="xl" display={"flex"} flexDirection={"column"} justifyContent={"space-evenly"} fontWeight={"medium"} fontStyle={"italic"}>
                        ...
                        <Text pb={"20px"}>We want educators to have more time on their hands. Our new AI content tools are poised to transform this process entirely.</Text>
                        <Text>Here’s what we’ve been working on regarding content and AI.</Text>
                    </Box>
                </Box>
            </Box>
            ...
            <Box >
                <Box>
                    <Box >
                        ...
                        <VStack spacing={8} align="center" color={"gray.500"} fontWeight={"medium"} >
                            <Heading as="h1" size="xl" pt={"20px"} width={"93%"} margin={"auto"} >
                                How will Edugen generate your quiz?
                            </Heading>

                            {/* Text Section */}
                            <Box>
                                <Text fontSize="2xl" textAlign="justify" width={"93%"} margin={"auto"} fontWeight={"medium"} fontStyle={"italic"}>
                ...
                <Box bg={"#f2f2f2"} mt={"30px"} width={"100%"} >
                    ...
                    {/* Header Section */}
                    <Box >
                        <Heading as="h1" fontSize={["3xl", "3xl", "4xl"]} pb={"20px"} pt={"30px"} color={"#757f94"} fontWeight={"bold"} width={"92%"} margin={"auto"}  >
                            Want to create quizzes that target specific levels of Bloom's Taxonomy? Use Edugen!
                        </Heading>
                        <Text fontStyle={"italic"} fontSize={"xl"} fontWeight={"medium"} color={"gray.500"} pb={5} textAlign={"justify"} width={"93%"} margin={"auto"}>
                    ...
                    <Box width={"93%"} margin={"auto"}>
                        <Text fontStyle={"italic"} fontSize={"xl"} fontWeight={"medium"} color={"gray.500"} pb={5}>
                        ...
                        <Text fontStyle={"italic"} fontSize={"xl"} fontWeight={"medium"} color={"gray.500"}>
                            Previously, a task that took hours or maybe days to complete can now be finished in minutes with the help of Edugen.
                        </Text>

                    </Box>
                    {/* Content Section */}
                    <Box pb={"20px"} width={"92%"} margin={"auto"}>
                        <Heading as="h1" fontSize={"35px"} mb={10} mt={"50px"} color={"#757f94"} fontWeight={"bold"}>
                        ...
                        >
                            ...
                            <Box textAlign="justify" fontSize={"18px"} fontWeight={"medium"} color={"gray.500"} width={{ base: "99%", sm: "99%", md: "50%", lg: "50%", xl: "50%", '2xl': "50%" }} >
                            ...
                            <Box borderRadius="md"
                                boxShadow="md"
                                width={{ base: "99%", sm: "99%", md: "50%", lg: "50%", xl: "50%", '2xl': "50%" }}>
                                <Image
            ...
            <Box bg={"#004789"} pt={"50px"} pb={"30px"} >
                <Box width={"70%"} margin={"auto"} color={"white"} display={"flex"} flexDirection={"column"} justifyContent={"space-evenly"} alignItems={"flex-start"}>
